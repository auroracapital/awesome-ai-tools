...
- [UpRes](https://upres.ai/) - Upscale images and video up to 8K with 14 specialized neural models (faces, text, print, art, video). Free tier, npm CLI, MCP server for AI agents.
